...
export default function WhatsAppIntegration() {
                    ...
                    placeholder={`[
  {
    ...
    "parameters": [
      ...
      <div style={{ marginTop: 8, border: '1px solid #e2e8f0', borderRadius: 12, padding: 16, background: '#fff' }}>
        ...
        {activityLoading ? (
          ...
          <div style={{ display: 'grid', gap: 8, maxHeight: 360, overflowY: 'auto', paddingRight: 2 }}>
            {userActivity.slice(0, 40).map((user) => (
                  ...
                  <div>
                    ...
                    {user.reminders.length > 0 ? (
                      <ul style={{ margin: '6px 0 0 18px', padding: 0, display: 'grid', gap: 4 }}>
                        {user.reminders.slice(0, 8).map((reminder) => (
