...
export default function SignUp({ onSuccess }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="auth-card signup-auth-card" style={{ maxWidth: 880 }}>
        <div className="signup-layout-intro" style={{ textAlign: 'center', marginBottom: 32 }}>
          <div style={{ 
        ...
        <div className="signup-layout-form">
          {error && (
            <div
              style={{
